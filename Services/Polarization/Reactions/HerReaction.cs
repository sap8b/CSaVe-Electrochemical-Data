...
namespace CSaVe_Electrochemical_Data
{
    ...
    public sealed class HerReaction : ElectrochemicalReaction
    {
        ...
        /// <summary>Minimum HER limiting current density for LM box bounds (A/cm2).</summary>
        public override double IlimMinAcm2 => 1.0e-2;

        /// <summary>Maximum HER limiting current density for LM box bounds (A/cm2).</summary>
