...
namespace CSaVe_Electrochemical_Data
{
    ...
    public sealed class OrrReaction : ElectrochemicalReaction
    {
        ...
        /// <summary>Minimum ORR limiting current density for LM box bounds (A/cm2).</summary>
        public override double IlimMinAcm2 => 1.0e-10;

        /// <summary>Maximum ORR limiting current density for LM box bounds (A/cm2).</summary>
