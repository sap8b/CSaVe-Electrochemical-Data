...
namespace CSaVe_Electrochemical_Data
{
    ...
    /// Uses an textbook −0.44 V for Fe/Fe2- standard potential of E0 = −0.44 V vs. SHE.
    ...
    public sealed class MetalOxidationReaction : ElectrochemicalReaction
    {
        ...
        /// <param name="metalCationConcentration">Dissolved metal cation concentration [M^z+] (mol/L, default 1.0e-6).</param>
