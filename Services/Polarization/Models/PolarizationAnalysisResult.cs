...
namespace CSaVe_Electrochemical_Data
{
    ...
    public sealed class PolarizationAnalysisResult
    {
        ...
        /// <summary>Corrosion current density icorr (A/cm2), evaluated from the fitted metal-oxidation BV component at Ecorr.</summary>
        ...
        /// <summary>ORR limiting current density ilim (A/cm2).</summary>
        ...
        /// <summary>Anodic exchange current density from Tafel back-extrapolation (A/cm2).</summary>
        ...
        /// <summary>Fitted ORR exchange current density I₀,ORR (A/cm2).</summary>
        ...
        /// <summary>Fitted HER exchange current density I₀,HER (A/cm2).</summary>
        ...
        /// <summary>
        /// Current densities (A/cm2) at each requested protection potential.
        ...
        /// <summary>Measured current density (A/cm2) at each merged plot potential; signed.</summary>
        ...
        /// <summary>
        /// Measured current density (A/cm2) for the raw anodic-file data only (two-file mode); signed.
        /// Empty in single-file mode.
        /// </summary>
        ...
        /// <summary>
        /// Measured current density (A/cm2) for the raw cathodic-file data only (two-file mode); signed.
        /// Empty in single-file mode.
        /// </summary>
        ...
        /// <summary>BV model total current density (A/cm2) at each model potential; signed.</summary>
        public IReadOnlyList<double> PlotModelCurrentDensityAcm2 { get; init; } = Array.Empty<double>();

        /// <summary>
        /// Metal-oxidation Butler-Volmer component current density (A/cm2) at each model potential;
        ...
        /// <summary>ORR Butler-Volmer + mass-transport component current density (A/cm2) at each model potential.</summary>
        public IReadOnlyList<double> PlotIorrAcm2 { get; init; } = Array.Empty<double>();

        /// <summary>HER Butler-Volmer component current density (A/cm2) at each model potential.</summary>
        ...
        /// current dynamic range.  Units: A/cm2.
        /// </summary>
