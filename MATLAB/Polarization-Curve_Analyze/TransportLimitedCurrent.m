function iLim = TransportLimitedCurrent(objCatModel, vApp, b)
...
%==========================================================================
    L1 = length(b);
    if L1 == 1
        iLim = zeros(size(vApp));
        num = objCatModel.z*objCatModel.c.F*objCatModel.diffusionCoefficient*objCatModel.cReactants(1);
        iLim(:) = num/b(1); %A/cm2        
    else
